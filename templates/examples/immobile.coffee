...
Gravitas = ->
  ...
  # 
renderer = class Immobile extends lowrollerTemplate
  #
...
"""
  ...
  bloviation: =>
    T.div '.m2',->
      T.h3 "The LowRoller on a Pedestal"
    cameraPos = "0 1.6 4"
    ...
    T.div ".container.right",=>
      T.tag "a-scene",embedded:true,physics:'debug: false; driver: local; gravity: -9.6; friction: 0.10; restitution: 0.300;',=>
        ...
        T.tag "a-sphere",  "#outie.red",
          lowroller:"debug:true; inner:4;outer:1;pursuit: 0,0 ;"
          position: "0 1.5 0"
          radius: "1"
        ...
        T.tag "a-sphere", "#marker-red", position: "0 0 0", radius: "0.5", color: "red"
...
db[id="lowroller/examples/immobile"] =
  ...
  memberOf: []
  created: "2018-10-13T03:37:31.079Z"
  lastEdited: "2018-10-13T03:37:31.079Z"
  published: "2018-10-13T03:37:31.079Z"
  embargo: "2018-10-13T03:37:31.079Z"
  captureDate: "2018-10-13T03:37:31.079Z"
  TimeStamp: 1539401851079
  debug: ""
